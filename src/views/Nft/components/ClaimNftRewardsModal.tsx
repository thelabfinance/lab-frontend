...
const ClaimNftRewardsModal: React.FC<ClaimNftRewardsModalProps> = ({ nft, balances, onSuccess, onDismiss, viewMode }) => {
  ...
  const farmsLP = useFarms().map((farm)=>{
    if(String(farm.quoteTokenSymbol) === 'BNB' ){
      console.log(`${wbnbPrice} wbnb price`)
  ...
  console.log(balances, 'testing balances in modal')

  const UpdateComponent = useForceUpdate()

  const handleClaim = async (address) => {
    try {
      console.log(rabbitMintingContract.methods, 'contract methods')
      console.log(`account address: ${account}, token address: ${address} and token ID: ${nft.bunnyId}`)
  ...
  console.log(balances, "balances in modal")
        ...
        <Tabs defaultActiveKey="pools" id="uncontrolled-tab-example" className="modalNavTabs">
            ...
            <StyledTable>
              ...
              <tbody>
                { balances.map((balance) => {
                  ...
                  console.log(` ${tokenPrice} token price for ${tokenSymbol} `)
            ...
            <StyledTable>
              ...
              { balances.map((balance) => {
                  ...
                  console.log(` price of ${tokenSymbol}: ${tokenPrice} `)
